...
public class SaidaParser extends Parser {
    ...
    public static class RContext extends ParserRuleContext {
        ...
        public TerminalNode ViolationResult() {
            return getToken(SaidaParser.ViolationResult, 0);
        }

        public TerminalNode TemporalOp() {
            return getToken(SaidaParser.TemporalOp, 0);
        }

        public TerminalNode Event() {
            return getToken(SaidaParser.Event, 0);
        }
